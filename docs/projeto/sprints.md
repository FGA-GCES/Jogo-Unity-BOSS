...
| Identificador(Tn) | Tarefa                                   | Descrição                                                                     | Responsável                                                     |
| ----------------- | ---------------------------------------- | ----------------------------------------------------------------------------- | --------------------------------------------------------------- |
| T1                | Releases notes semanais                  | Produzir relatórios semanais de atualizações do projeto (Release Notes)       | Todo o Grupo (será aberto um Docs)                              |
| T2                | Implementar software livre de Clean Code | Adicionar ferramenta de análise de Clean Code ao projeto                      | Artur Bartz, Carlos Henrique, Vinicius Castelo, Vinicius Rufino |
